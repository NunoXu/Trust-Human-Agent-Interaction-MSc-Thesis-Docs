...
\input{content/CSSXML}

% --------------------------------------------------------
%\printccsdesc
\keywords{\ac{AI}, \ac{HRI}, Trust Modelling, Trust Evaluation}
% --------------------------------------------------------
...
\bibliography{bib/library}  % sigproc.bib is the name of the Bibliography in this case
