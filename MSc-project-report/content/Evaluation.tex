...
\label{subsec:Evaluation:Split or Steal}
...
\begin{table}[]
	...
	\begin{tabular}{l|l|l|}
		\cline{2-3}
		& $C_2$   & $D_2$   \\ \hline
		\multicolumn{1}{|l|}{$C_1$} & 1,1 & 0,2 \\ \hline
		\multicolumn{1}{|l|}{$D_1$} & 2,0 & 0,0 \\ \hline
	\end{tabular}
