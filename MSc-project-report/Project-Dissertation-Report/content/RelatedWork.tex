...
The hierarchy is composed of three languages, starting with \textit{$L_{basic}$} being the base language, that expresses the ontology and contains the symbols to represent the domain.
