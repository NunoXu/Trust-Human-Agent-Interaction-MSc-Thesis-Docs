...
\begin{table}[]
	...
	\begin{tabular}{ccc}
		...
		$B_{i_c} (pr\geq([R_{rj_c} T_{r_w_1}, V_{w_1}]))$ & & $B_{i_c} (s(pr\geq([R_{rj_c} T_{r_w1}, V_{w_1}])))$ \\
		$B_{i_c} (pr\geq([R_{rj_c} T_{r_w_2}, V_{w_2}]))$ & & $B_{i_c} (s(pr\geq([R_{rj_c} T_{r_w1}, V_{w_1}])))$ \\
		... & & ...
	\end{tabular}
\end{table}
