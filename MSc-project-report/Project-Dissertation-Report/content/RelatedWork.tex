...
The model also conceptualizes \textbf{Expectation} as when agent \textbf{X} waits for $\rho$ to happen when an action $\alpha$ trusted to \textbf{Y} is being performed.
