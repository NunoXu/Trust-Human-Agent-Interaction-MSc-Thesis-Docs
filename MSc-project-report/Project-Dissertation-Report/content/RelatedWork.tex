...
The model also conceptualizes \textbf{Expectation} as when agent X waits for $\rho$ to happen when an action $\alpha$ trusted to Y is being performed, formalized in first order logic in equation \ref{eq:TrustExpectation}.
\begin{equation}
	\begin{aligned}
...
\end{equation}
This can be used to establish initial expectations of the user in the agent.
