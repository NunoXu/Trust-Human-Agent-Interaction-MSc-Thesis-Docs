...
The last element is the analyser and its job is to propose actions to improve the accuracy of predicates in Repage and solve cognitive dissonances to produce certainty.
