...
\textbf{Degrees of Trust} quantifies the Trust level agent X has in Y with action $\alpha$ according to the formula depicted in \ref{eq:DegreeOfTrust}, where $c_{something}$ are constants that give weights to each \ac{DoC}
\begin{equation}
	\begin{aligned}
