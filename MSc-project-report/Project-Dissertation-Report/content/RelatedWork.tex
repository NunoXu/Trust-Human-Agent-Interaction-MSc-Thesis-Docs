...
\textit{BC}-logic is structured hierarchically, in a way that formulas from a certain first-order language can be embedded another language as constants of the language. 
