...
Pinyol et al. \cite{Pinyol2009} propose an integration of the Repage model, introduced in the previous Section \ref{subsubsec:Related work:Trust Models:Repage} into a BDI Agent. While the BDI model is not relevant to us, their work specify a belief first order logic that is capable of representing Repage predicate semantics.
