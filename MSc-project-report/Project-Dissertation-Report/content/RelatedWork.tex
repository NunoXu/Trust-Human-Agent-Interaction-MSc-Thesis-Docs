...
\end{equation}
$F_{X, Y, \tau}$ should associate the \textit{strengh-of-sources ($Str_j$)} and \textit{quality-values ($\text{\textit{Qual-i}}_{sjY}(\tau)$)} with a probability curve. It should also selective with the beliefs received, as some may be discarded or integrated, and normalize the quality values.  \\
