...
The model also conceptualizes \textbf{Expectation} as when agent X waits for $\rho$ to happen when an action $\alpha$ trusted to Y is being performed, formalized in equation 
