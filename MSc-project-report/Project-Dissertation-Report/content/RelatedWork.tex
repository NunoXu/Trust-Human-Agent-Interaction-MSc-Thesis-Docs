...
\textbf{\ac{DoC}} quantifies the Trust level agent X has in Y with action $\alpha$ according to the formula depicted in \ref{eq:DegreeOfTrust}.
\begin{equation}
	\begin{aligned}
...
Where:
\begin{itemize}
	\item $DoC_x[Opp_y(\alpha, \rho)]$ is the \ac{DoC} of 
\end{itemize}
