...
\begin{itemize}
	...
	\item a pair ($\bm{\tau}$) composed by the action $\alpha$ entrusted to the trustee, that possibly produces an outcome $\rho$, $(\alpha, \rho)$ that is contained in the goal of X ($g_x$);
