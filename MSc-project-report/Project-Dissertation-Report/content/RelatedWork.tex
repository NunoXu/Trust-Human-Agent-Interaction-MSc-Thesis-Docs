...
Pinyol et al. \cite{Pinyol2009} propose an integration of the Repage model, introduced in the previous Section \ref{subsubsec:Related work:Trust Models:Repage} with a BDI Agent 
