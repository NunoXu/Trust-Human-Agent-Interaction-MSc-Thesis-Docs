...
We will then compare the Trust value of both groups, and if the value of \textit{Group B} is greater by a significant margin, it will provides with the positive feedback to further continue this line of research.
