...
We can represent betraying as defecting (D), and staying silent as cooperating (C). So the game's possible outcomes can be represented by a payoff matrix, like the one in table \ref{PrisonerDilemaPayoffMatrix} where each entry represents a tuple of the form player1 payoff, player2 payoff.
