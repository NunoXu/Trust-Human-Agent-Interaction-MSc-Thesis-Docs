...
\end{itemize}
By describing trust as a mental attitude it also implied that: `Only a cognitive agent can trust another agent; only an agent endowed with goals and beliefs'.
