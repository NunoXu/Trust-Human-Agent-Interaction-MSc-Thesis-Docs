...
\begin{itemize}
	\item Epistemic decisions: accepting beliefs to update or generate a given image or reputation;
	\item Pragmatic-Strategic decisions: accepting beliefs to update or generate a given image or reputation;
\end{itemize}
