...
Implementation wise, the model will be 1st implemented by using a simple class structure, as seen in figure \ref{fig:classDiagram}. Simulations can be run by instantiating the relevant agents and actions in the environment, and either register callback functions for the 
