%% Remodel, change from 1st model to just model
% focus on trust transmitability and range of dimensions to the trust value

\section{Representing Trust Features}
\label{sec:RepresentingTrustFeatures}

% We seperate ability from willingness explicity but leave image and reputation 
% Trust is represented as an object that references an agent, a specific trustee and a task
