...
We seek to represent the trustee as a collection of features from which an overall evaluation may be retrieved. This features represent the trustee's abilities in various fields, for example, a set of features may be $  \left cooking, writing\right $ This makes visualization of a certain trustee's trust reasoning, as we can observe all the factors that contribute towards an evaluation. as represented in Figure \ref{fig:trustee}. These features must be able to provide 2 values:
