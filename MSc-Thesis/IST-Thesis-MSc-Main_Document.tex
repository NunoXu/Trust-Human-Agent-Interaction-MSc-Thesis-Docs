...
% -----------------------------------------------------------------------------
\input{IST-Thesis-MSc-Preamble_commands}
...
\input{IST-Thesis-MSc-Front_Cover}
...
\begin{acknowledgments}
	\input{./Chapters/IST-Thesis-MSc-Acknowledgments.tex}
\end{acknowledgments}
...
\begin{abstract}
	\input{./Chapters/IST-Thesis-MSc-Abstract-EN-Abstract.tex}
\end{abstract}
\begin{keywords}
	\input{./Chapters/IST-Thesis-MSc-Abstract-EN-KeyWords.tex}
\end{keywords}
\clearpage
\thispagestyle{empty}
...
\begin{resumo}
	\input{./Chapters/IST-Thesis-MSc-Abstract-PT-Resumo.tex}
\end{resumo}
\begin{palavraschave}
	\input{./Chapters/IST-Thesis-MSc-Abstract-PT-PalavrasChave.tex}
\end{palavraschave}
\clearpage
\thispagestyle{empty}
%% If Printing on DOUBLE SIDED pages, the second page should be white.
...
\input{./Chapters/IST-Thesis-MSc-Acronyms.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
...
%Chapter 1
\input{./Chapters/IST-Thesis-MSc-Chapter_1.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
%
%Chapter 2
\input{./Chapters/IST-Thesis-MSc-Chapter_2.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
%
%Chapter 3
\input{./Chapters/IST-Thesis-MSc-Chapter_3.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
%
%Chapter 4
\input{./Chapters/IST-Thesis-MSc-Chapter_4.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
%
%Chapter 5
\input{./Chapters/IST-Thesis-MSc-Chapter_5.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
%Chapter 6
...
%
%Chapter 7
\input{./Chapters/IST-Thesis-MSc-Chapter_7.tex}
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
%\cleardoublepage
%
...
\bibliography{bib/library} % Put here your own filename
% If Printing on DOUBLE SIDED pages, the second page should be white.
% Otherwise, comment the following command:
\ULforem
%\cleardoublepage
...
%\input{./Chapters/IST-Thesis-MSc-AppendixA.tex}
\input{./Chapters/IST-Thesis-MSc-QuestionnaireAppendix.tex}
...
\input{./Chapters/IST-Thesis-MSc-AppendixC.tex}
