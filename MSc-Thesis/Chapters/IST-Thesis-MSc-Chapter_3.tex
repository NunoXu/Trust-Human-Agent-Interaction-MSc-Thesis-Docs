...
Overall \textit{BC}-logic is an interesting approach to representing beliefs in the Repage model, but we found it to be too complex to be used, as we wanted to maintain simplicity with the model's design.
